...
class Search_Screen extends StatefulWidget {
  ...
  const Search_Screen({super.key, required this.searchQuery});
...
class _Search_ScreenState extends State<Search_Screen> {
  ...
  final Search_Services search_services = Search_Services();
  ...
  fetchSearchedProduct() async {
    products = await search_services.fetchSearchedProduct(
